export default {
  ...
  'menu.security.user-statistics': 'User statistics',
  'menu.security.actions': 'List actions',
  'menu.security.resources': 'List resources',
  'menu.security.permissions': 'List permissions',
  'menu.logs': 'Logs',
  'menu.logs.runs': 'Runs',
  'menu.logs.jobs': 'Jobs',
